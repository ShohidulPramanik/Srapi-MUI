...
export interface ApiProructProruct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    prvPrice: Attribute.Integer & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::proruct.proruct': ApiProructProruct;
